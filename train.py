...
dataset = histologyDataset("./histology_dataset/20/train/images/", "./histology_dataset/20/train/GT/", color=True, transform=transforms.Compose([Brightness(100), Rotate(), ToTensor(), Resize(size=(256, 256))]))
